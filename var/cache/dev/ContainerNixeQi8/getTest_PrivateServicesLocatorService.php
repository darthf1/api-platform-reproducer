...
class getTest_PrivateServicesLocatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\ApiPlatform\\DataProvider\\MyCollectionDataProvider' => ['privates', 'App\\ApiPlatform\\DataProvider\\MyCollectionDataProvider', 'getMyCollectionDataProviderService', true],
            ...
            'api_platform.elasticsearch.client' => ['privates', 'api_platform.elasticsearch.client', 'getApiPlatform_Elasticsearch_ClientService', true],
            'api_platform.elasticsearch.metadata.resource.metadata_factory.operation' => ['privates', 'api_platform.elasticsearch.metadata.resource.metadata_factory.operation', 'getApiPlatform_Elasticsearch_Metadata_Resource_MetadataFactory_OperationService', false],
            'api_platform.elasticsearch.cache.metadata.document' => ['privates', 'api_platform.elasticsearch.cache.metadata.document', 'getApiPlatform_Elasticsearch_Cache_Metadata_DocumentService', true],
            'api_platform.elasticsearch.metadata.document.metadata_factory.configured' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.configured', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_ConfiguredService', true],
            'api_platform.elasticsearch.metadata.document.metadata_factory.attribute' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.attribute', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_AttributeService', true],
            'api_platform.elasticsearch.metadata.document.metadata_factory.cat' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cat', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CatService', true],
            'api_platform.elasticsearch.metadata.document.metadata_factory.cached' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cached', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CachedService', true],
            'api_platform.elasticsearch.name_converter.inner_fields' => ['privates', 'api_platform.elasticsearch.name_converter.inner_fields', 'getApiPlatform_Elasticsearch_NameConverter_InnerFieldsService', false],
            'api_platform.elasticsearch.normalizer.item' => ['privates', 'api_platform.elasticsearch.normalizer.item', 'getApiPlatform_Elasticsearch_Normalizer_ItemService', false],
            'api_platform.elasticsearch.normalizer.document' => ['privates', 'api_platform.elasticsearch.normalizer.document', 'getApiPlatform_Elasticsearch_Normalizer_DocumentService', false],
            'api_platform.elasticsearch.item_data_provider' => ['privates', 'api_platform.elasticsearch.item_data_provider', 'getApiPlatform_Elasticsearch_ItemDataProviderService', true],
            'api_platform.elasticsearch.collection_data_provider' => ['privates', 'api_platform.elasticsearch.collection_data_provider', 'getApiPlatform_Elasticsearch_CollectionDataProviderService', true],
            'api_platform.elasticsearch.identifier_extractor' => ['privates', 'api_platform.elasticsearch.identifier_extractor', 'getApiPlatform_Elasticsearch_IdentifierExtractorService', true],
            'api_platform.elasticsearch.request_body_search_extension.constant_score_filter' => ['privates', 'api_platform.elasticsearch.request_body_search_extension.constant_score_filter', 'getApiPlatform_Elasticsearch_RequestBodySearchExtension_ConstantScoreFilterService', true],
            'api_platform.elasticsearch.request_body_search_extension.sort_filter' => ['privates', 'api_platform.elasticsearch.request_body_search_extension.sort_filter', 'getApiPlatform_Elasticsearch_RequestBodySearchExtension_SortFilterService', true],
            'api_platform.elasticsearch.request_body_search_extension.sort' => ['privates', 'api_platform.elasticsearch.request_body_search_extension.sort', 'getApiPlatform_Elasticsearch_RequestBodySearchExtension_SortService', true],
            ...
            'api_platform.elasticsearch.normalizer.item.inner' => ['privates', 'api_platform.elasticsearch.normalizer.item.inner', 'getApiPlatform_Elasticsearch_Normalizer_Item_InnerService', false],
            ...
            'App\\ApiPlatform\\DataProvider\\Filter\\SearchFilterInterface' => ['privates', 'App\\ApiPlatform\\DataProvider\\Filter\\MyFilter', 'getMyFilterService', true],
            ...
            'api_platform.elasticsearch.metadata.document.metadata_factory' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cached', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CachedService', true],
            'ApiPlatform\\Elasticsearch\\Metadata\\Document\\Factory\\DocumentMetadataFactoryInterface' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cached', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CachedService', true],
            'ApiPlatform\\Core\\Bridge\\Elasticsearch\\Metadata\\Document\\Factory\\DocumentMetadataFactoryInterface' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cached', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CachedService', true],
            'ApiPlatform\\Core\\Bridge\\Elasticsearch\\Api\\IdentifierExtractorInterface' => ['privates', 'api_platform.elasticsearch.identifier_extractor', 'getApiPlatform_Elasticsearch_IdentifierExtractorService', true],
            ...
            'api_platform.elasticsearch.metadata.document.metadata_factory.attribute.inner' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.configured', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_ConfiguredService', true],
            ...
            'api_platform.elasticsearch.metadata.resource.metadata_factory.operation.inner' => ['privates', 'api_platform.metadata.resource.metadata_factory.operation', 'getApiPlatform_Metadata_Resource_MetadataFactory_OperationService', false],
            'api_platform.elasticsearch.metadata.document.metadata_factory.cat.inner' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.attribute', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_AttributeService', true],
            'api_platform.metadata.resource.metadata_factory.formats.inner' => ['privates', 'api_platform.elasticsearch.metadata.resource.metadata_factory.operation', 'getApiPlatform_Elasticsearch_Metadata_Resource_MetadataFactory_OperationService', false],
            ...
            'api_platform.serializer.normalizer.item' => ['privates', 'api_platform.elasticsearch.normalizer.item', 'getApiPlatform_Elasticsearch_Normalizer_ItemService', false],
            ...
            'api_platform.elasticsearch.metadata.document.metadata_factory.cached.inner' => ['privates', 'api_platform.elasticsearch.metadata.document.metadata_factory.cat', 'getApiPlatform_Elasticsearch_Metadata_Document_MetadataFactory_CatService', true],
        ], [
            ...
            'api_platform.elasticsearch.normalizer.item.inner' => '?',
            ...
            'App\\ApiPlatform\\DataProvider\\Filter\\SearchFilterInterface' => '?',
            ...
            'ApiPlatform\\Core\\Bridge\\Elasticsearch\\Metadata\\Document\\Factory\\DocumentMetadataFactoryInterface' => '?',
            ...
            'api_platform.elasticsearch.metadata.document.metadata_factory.attribute.inner' => '?',
            'api_platform.metadata.resource.metadata_factory.operation.inner' => '?',
            'api_platform.elasticsearch.metadata.resource.metadata_factory.operation.inner' => '?',
            'api_platform.elasticsearch.metadata.document.metadata_factory.cat.inner' => '?',
            ...
            'api_platform.elasticsearch.metadata.document.metadata_factory.cached.inner' => '?',
        ]);
    }
}
